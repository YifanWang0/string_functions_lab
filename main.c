...
/*
  ...
  printf("Concatenating \"happiness\" and \"sadness\"");
  concatenate(str1, str3);
  for (i = 0; i < len(str1); i++) {
    printf("%c",str1[i] );
  }
  printf("\n" );
  printf("Concatenating \"happinesssadness\" with \"anger\":" );
  ...
  printf("Concatenating \"sadness\" with first five letters of \"happinesssadness\"\n");
  concatenate_n(str2, str1, 5);
  for (i = 0; i < len(str1); i++) {
    printf("%c",str1[i] );
  }
  printf("\n\n");
